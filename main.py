...
from trackers import PlayersTracker, BallTracker
...
def main():
    ...
    player_tracker = PlayersTracker(model_path = 'yolov8l')
    ball_tracker = BallTracker(model_path = 'models/best-ball-detection.pt')
    ...
    court_model_path = "models/model_keypoints.pth"
    court_line_detector = CourtKeypointsDetector(court_model_path)
